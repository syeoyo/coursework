...
\begin{frame}{문제 정의}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{cccc}
            ...
            \\ \cline{2-4}
            \multicolumn{1}{c|}{}                              & \multicolumn{1}{c|}{A}        &      & $d_i$
            \\ \hline
        \end{tabular}
    \end{table}
...
\begin{frame}{Fairness as a risk measure}
...
\begin{frame}{추후 계획}
    1. vss \\
    1. deviation risk measure \\ 2. quantile risk measure \\
    다양한 risk measure을 통한 공정성을 지킴으로 인한 수익 감소 혹은 안 지켰을때의 deviation 확률
\end{frame}
